...
const dict: Record<string, { ko: string; en: string }> = {
  ...
  "loading.connections": { ko: "사업장 연결을 불러오는 중…", en: "Loading venue connections…" },
  "loading.incomeDetails": {
    ko: "세금·증빙 정보를 불러오는 중…",
    en: "Loading tax and proof details…",
  },
  ...
  "me.timeline.loadMore": { ko: "이전 내역 더 보기", en: "Load older entries" },
  "me.timeline.loadingMore": { ko: "이전 내역을 불러오는 중…", en: "Loading older entries…" },
